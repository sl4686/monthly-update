...
(function () {
  ...
  const EXEC_SUMMARY = [
    ...
    "Total ARR increased 3% MoM to $28.4M (\u2212$7.4M vs plan YTD), with $589k of Reporting go-lives in July and $2.66M YTD.",
    ...
    KPI_DEFS.forEach((def) => {
      if (def.closed) {
        ...
        const card = kpiCard(
          ...
          (actual.name ? actual.name + " \u00b7 " : "") + "quarter to date",
          chips
        );
        if (pct) {
